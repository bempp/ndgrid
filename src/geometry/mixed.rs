...
pub use entity_geometry::{MixedEntityGeometry, MixedEntityGeometryBorrowed};
#[cfg(feature = "serde")]
pub(crate) use geometry::SerializableGeometry;
pub use geometry::{MixedGeometry, MixedGeometryBorrowed};
...
mod test {
    ...
    fn example_geometry_triangles(
    ) -> MixedGeometry<f64, CiarletElement<f64, IdentityMap>> {
    ...
    make_tests!(lexample_geometry_triangles);
}
